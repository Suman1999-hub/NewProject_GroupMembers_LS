...
const InviteMembersModal = ({ isOpen, data, toggle, onSuccess = () => {} }) => {
  ...
  return (
    <Modal
      ...
      toggle={() => _closeModal()}
    >
      <ModalHeader toggle={() => _closeModal()}>Invite Members</ModalHeader>
